# Generated by Django 4.0.5 on 2022-07-28 16:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='User_info',
            fields=[
                ('user_info_id', models.CharField(max_length=256, primary_key=True, serialize=False, verbose_name='user_info_id')),
        ...
        migrations.CreateModel(
            name='Vis_prefer',
            fields=[
                ('prefer_id', models.CharField(max_length=256, primary_key=True, serialize=False, verbose_name='prefer_id')),
                ('user_id', models.CharField(max_length=256, verbose_name='사용자')),
